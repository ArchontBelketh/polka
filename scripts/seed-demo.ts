/**
 * Dev-only demo data: a demo developer + sample approved products.
 * Run: npm run db:seed:demo   (blocked in production — see scripts/guard.ts)
 */
...
async function main() {
  assertNotProduction("Демо-сид продуктов")
