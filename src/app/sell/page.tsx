...
const FAQ = [
  {
    ...
    a: "После покупки деньги держатся в эскроу 7 дней — это окно на возврат для покупателя. Если спора нет, сумма зачисляется на ваш баланс, откуда вы выводите её на карту.",
  },
  {
