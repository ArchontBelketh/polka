...
export const metadata: Metadata = {
  ...
  description:
    "Выложите свой бот, парсер или 1С-обработку и получайте до 80% с продажи. Площадка берёт на себя оплату, доставку и возвраты. Загрузка за 15 минут.",
  openGraph: {
    title: "Продавать на ПОЛКЕ — заработок на готовых скриптах",
...
const STEPS = [
  ...
  { icon: TrendingUp, title: "Продажи", text: "Продукт в каталоге. Оплата, доставка файлов и возвраты — на площадке. Вывод средств на баланс." },
]
...
const FAQ = [
  {
    ...
    a: "После покупки деньги держатся в эскроу 7 дней — это окно на возврат для покупателя. Если спора нет, сумма зачисляется на ваш баланс. Запрос на вывод обрабатывается администратором по вторникам и пятницам; при отклонении сумма возвращается на баланс.",
  },
  {
  ...
  {
    q: "Как покупатель открывает спор и что будет со мной?",
    a: "Если продукт не соответствует описанию, покупатель открывает спор в течение эскроу-окна. Модератор смотрит переписку и продукт и решает: возврат или отказ. Честным разработчикам спор ничем не грозит.",
  },
  {
...
const PLANS = [
  {
    ...
    price: "0 ₽",
    highlight: false,
    features: ["2 слота под продукты", "Комиссия 20%", "Автоскан и модерация", "Эскроу и защита сделок"],
  },
  {
    name: "Докупка слотов",
    price: "разово",
      ...
      <section className="border-b border-border">
        <div className="mx-auto max-w-4xl px-4 py-20 text-center space-y-6">
          ...
          <p className="mx-auto max-w-2xl text-lg text-muted-foreground">
            ...
            снова и снова. ПОЛКА берёт на себя оплату, доставку и возвраты — вы получаете до 80%
            с каждой продажи.
          </p>
