...
const SAFETY_RULES = [
  ...
  },
  {
    ...
    text: "Проверяйте продукт в виртуальной машине, отдельном контейнере или тестовом аккаунте, а не на рабочей системе с доступом к боевым данным.",
  },
  {
    icon: KeyRound,
    title: "Не выдавайте лишних прав",
    text: "Запускайте без прав администратора, если это явно не требуется. Не вводите пароли и токены от боевых сервисов, пока не убедитесь, что всё чисто.",
  },
  {
    icon: ScanLine,
