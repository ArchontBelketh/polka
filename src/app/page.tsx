...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Готовые программные продукты для бизнеса с проверкой кода и ручной модерацией.",
    url: APP_URL,
  ...
  twitter: {
    ...
    title: "CYBERПОЛКА — маркетплейс готовых программ с проверкой кода",
    description: "Готовые программы для бизнеса с проверкой кода и ручной модерацией.",
